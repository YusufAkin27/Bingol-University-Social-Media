...
public class FollowRelationController {
    ...
    public DataResponseMessage getFollowing(@AuthenticationPrincipal UserDetails userDetails, Pageable pageable) throws StudentNotFoundException {
    ...
    public DataResponseMessage getFollowers(@AuthenticationPrincipal UserDetails userDetails, Pageable pageable) throws StudentNotFoundException {
    ...
    public DataResponseMessage searchFollowers(
    ...
    public DataResponseMessage searchFollowing(
            @AuthenticationPrincipal UserDetails userDetails,
            @RequestParam String query,
            Pageable pageable) throws StudentNotFoundException {
    ...
    public DataResponseMessage getFollowingPosts(@AuthenticationPrincipal UserDetails userDetails, @PathVariable String username) throws StudentNotFoundException {
