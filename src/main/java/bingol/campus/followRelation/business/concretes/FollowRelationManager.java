...
public class FollowRelationManager implements FollowRelationService {
    ...
    @Override
    public DataResponseMessage getFollowers(String username, Pageable pageable) throws StudentNotFoundException {
        // Sayfa boyutunu 10 olarak ayarla (size = 10)
        Pageable pageRequest = PageRequest.of(pageable.getPageNumber(), 10, pageable.getSort());
    ...
    @Override
    public DataResponseMessage searchFollowers(String username, String query, Pageable pageable) throws StudentNotFoundException {
        // Öğrenci kontrolü
        Student student = studentRepository.getByUserNumber(username);
    ...
    @Override
    public DataResponseMessage searchFollowing(String username, String query, Pageable pageable) throws StudentNotFoundException {
        // Öğrenci kontrolü
        Student student = studentRepository.getByUserNumber(username);
    ...
    @Override
    public DataResponseMessage getFollowingPosts(String username, String username1) throws StudentNotFoundException {
        // Öğrencileri al
        Student student = studentRepository.getByUserNumber(username);
        Student student1 = studentRepository.getByUserNumber(username1);
