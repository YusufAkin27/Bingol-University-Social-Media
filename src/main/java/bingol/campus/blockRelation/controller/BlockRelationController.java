...
public class BlockRelationController {
    ...
    @GetMapping("/blocked")
    public DataResponseMessage getBlockedUsers(@AuthenticationPrincipal UserDetails userDetails, Pageable pageable) throws StudentNotFoundException {
    ...
    public DataResponseMessage getBlockHistory(@AuthenticationPrincipal UserDetails userDetails,@PathVariable Long userId) throws BlockUserNotFoundException, StudentNotFoundException {
    ...
    public DataResponseMessage getUserDetails(@AuthenticationPrincipal UserDetails userDetails, @PathVariable Long userId) throws BlockUserNotFoundException, StudentNotFoundException {
