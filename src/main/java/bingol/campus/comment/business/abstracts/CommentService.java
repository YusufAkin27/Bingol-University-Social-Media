...
public interface CommentService {
    ResponseMessage addCommentToStory(String username, Long storyId, String content) throws StudentNotFoundException, StoryNotFoundException, StoryNotActiveException, BlockingBetweenStudent, NotFollowingException, StudentProfilePrivateException;

    ResponseMessage addCommentToPost(String username, Long postId, String content) throws PostNotFoundException, StudentNotFoundException, PostNotIsActiveException, NotFollowingException, BlockingBetweenStudent, StudentProfilePrivateException;
    ...
    DataResponseMessage<List<CommentDTO>> getStoryComments(String username, Long storyId, Pageable pageable) throws NotFollowingException, BlockingBetweenStudent, StoryNotActiveException, StudentNotFoundException, StoryNotFoundException, StudentProfilePrivateException;

    DataResponseMessage<List<CommentDTO>> getPostComments(String username, Long postId, Pageable pageable) throws StudentNotFoundException, PostNotFoundException, PostNotIsActiveException, NotFollowingException, BlockingBetweenStudent, StudentProfilePrivateException;
}
